...
- `surfaceAzimuth`: azimuth angle of the PV modules (0째 = north, 90째 = east, 180째 = south 270째 = west)
- `surfaceTilt`: tilt angle of the PV modules (0째 = flat on the earth, 90째 = means vertically)
